...
| **Text** | Documentation and specification text: this file, the README, `ARCHITECTURE.md`, `GOVERNANCE.md`, `STATUS.md`, the project mark at `assets/awig-mark.png`, and the docs shipped under `code/` (`code/README.md`, `code/LICENSING.md`). | **CC BY 4.0** | Share and adapt freely for any purpose, with attribution. |
