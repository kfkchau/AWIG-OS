...
|---|---|---|---|
| The Python interpreter | Your system's `python3.12`, its loader, the C library pieces it needs and its standard library, staged into a sealed image | Your own machine | Python: PSF-2.0. The C library pieces are your system's own copies (LGPL); you stage them, we redistribute nothing |
